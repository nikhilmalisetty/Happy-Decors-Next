...
const Navbar3 = (props) => {
  return (
    <>
      <div className={`navbar3-container ${props.rootClassName} `}>
        <header data-thq="thq-navbar" className="navbar3-navbar-interactive">
          ...
          <div data-thq="thq-navbar-nav" className="navbar3-desktop-menu">
            <nav className="navbar3-links">
              <Link href="/">
                <a className="navbar3-link thq-link thq-body-small">
                  {props.link1}
                </a>
              </Link>
              <Link href="/gallery">
                <a className="navbar3-link1 thq-link thq-body-small">
                  {props.link2}
                </a>
              </Link>
              <Link href="/contact">
                <a className="navbar3-link2 thq-link thq-body-small">
                  {props.link3}
                </a>
              </Link>
            </nav>
      ...
      <style jsx>
        {`
          ...
          .navbar3-root-class-name {
            fill: var(--dl-color-theme-neutral-dark);
            color: var(--dl-color-theme-neutral-dark);
          }

          .navbar3-root-class-name3 {
            align-self: center;
          }
          .navbar3-root-class-name4 {
            align-self: center;
          }
